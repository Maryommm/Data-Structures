...
//=============================================================================
    ...
    public static void productsMenu()
    {
        ...
        switch (choice)
        {
            ...
            case 2:
            {
                System.out.println("Products cant be removed from system unless do not have orders or reviews , other wise will be archived");
                ...
                if (p != null)
                {
                    if (p.getReviews().size() == 0)
                    {
                        ...
                        {
                            products.insert(p);
                            System.out.println("Cant be removed it has OLD orders, will be archived");
                            deleted = false;
                        }
                    }
                    else// it has reviews
                    {
                        products.insert(p);
                        System.out.println("Cant be removed it has reviews, will be archived");
                        deleted = false;
                    }
                }
                if ( deleted)
    ...
    public static void AddNewReview()
    {
        ...
        int pID =input.nextInt();
        while ( ! pdata.AvailableProductID(pID))
        {
    ...
    public static LinkedList <Review> AllReviewsForCustomer()
    {
            ...
            else
            {
                ...
                while ( ! selectedReviews.last())
                {
                    ...
                    Product p = pdata.getProductData(selectedReviews.retrieve().getProduct());
